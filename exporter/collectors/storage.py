...
disk_read_mb_s   = Gauge('disk_read_mb_s',       'Velocità lettura disco in MB/s',  ['disk'])
disk_write_mb_s  = Gauge('disk_write_mb_s',      'Velocità scrittura disco in MB/s', ['disk'])
disk_read_total  = Gauge('disk_read_total_mb',   'Totale dati letti in MB',          ['disk'])
disk_write_total = Gauge('disk_write_total_mb',  'Totale dati scritti in MB',        ['disk'])
